...
1. Clone the repository:
    ...
    ```bash
    git clone https://github.com/sanjay-kumar7148/Credit-Scoring-Model.git
    ```
...
## Acknowledgements
Special thanks to CodeAlpha for providing the educational resources and project materials.
